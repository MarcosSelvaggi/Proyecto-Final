...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container2">
        <div style="max-width: 700px; width: 100%;">
            <h2 class="text-center mb-4"><i class="bi bi-caret-right-fill"></i>Modificar Información Personal<i class="bi bi-caret-left-fill"></i></h2>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 text-center mt-4">
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="btnEnviar">
                                    <asp:Button ID="BtnModificar" runat="server" Text="Modificar" CssClass="BtnEnviar" OnClick="BtnModificarPerfil_Click" />
                                </div>
                            </div>
            ...
            <div class="modal-dialog" style="min-width: 400px; width: 90%">
                <div class="modal-content">
                    <div class="modal-header bg-success text-white">
                        <h1 class="modal-title fs-5" runat="server">Información actualizada correctamente</h1>
                    </div>
